<template>
  <div class="quality-features py-10">
    <v-container fluid>
      <v-row>
        <v-col v-for="card in cards" :key="card.title" class="px-2">
          <v-hover v-slot="{ isHovering, props }">
            <v-card
              ...
              :color="isHovering ? 'purple-lighten-4' : 'white'"
            >
              <div class="box">
...
export default {
  data: () => ({
    cards: [
      ...
      {
        title: "Fast Shipping",
        desc: "Fast and conveniebt door to door delivery",
        svg: `
            <svg
              aria-hidden="true"
              focusable="false"
      ...
      },
      {
        ...
        desc: "More than 10 different payments methods",
        svg: `
            <svg
              aria-hidden="true"
              focusable="false"
