<template>
  <div class="nav-bar">
    <v-app-bar color="#161880" height="fit-content" absolute>
      <v-container fluid>
        <v-row class="align-center">
          ...
          <v-col cols="4">
            <div class="parent text-white d-flex justify-space-between align-center">
              ...
              <div class="nav-popups wishlist d-flex flex-column align-center">
                <svg viewBox="0 0 512 512" class="nav-icon icon-wishlist">
                  <g>
                    <g>
                      <path
                ...
                <span class="mt-1">Wish Lists</span>
              </div>
              <div class="nav-popups signin d-flex flex-column align-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  xmlns:xlink="http://www.w3.org/1999/xlink"
                  class="nav-icon icon-account"
        ...
        <v-row class="mt-6">
          ...
          <v-col cols="5" class="d-flex justify-end" style="gap: 35px">
            <div class="help d-flex align-center text-white">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fas"
            ...
            <div class="lang d-flex align-center text-white" id="lang-btn">
